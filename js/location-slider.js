...
(function() {
  ...
  function ISMSlider(element_id, options) {
    ...
    function init_config(given_opts) {
      ...
      // <div class="location-slider" data-transition-type="" data-play-type="" data-pause="" data-interval="" data-image-fx="" data-buttons="" data-radios="">
  ...
  iq.ready(function() {
    ...
    {
      var slider_divs = iq(".location-slider");
      for(var i = 0; i < slider_divs.length; i++)
      {
        var slider_div = slider_divs.get(i);
        slider_div.id = slider_div.id || "location-slider-" + i;
